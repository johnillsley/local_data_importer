...
$string['academicyearformat'] = 'Academic year format';
...
$string['dateintervalenddatefield_desc'] = 'The database field that holds the date interval end date in unixtime format';
$string['dateintervalcodefield'] = 'Date interval name field';
$string['dateintervalcodefield_desc'] = 'The database field that holds the code for the date interval';
$string['dateintervalstartdatefield'] = 'Date interval start date field';
